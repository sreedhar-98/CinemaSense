...
const SIgnInSignUp = () => {
  return (
    <div className="absolute flex flex-col w-full mt-24 md:my-auto md:p-12 md:bg-black/60 md:rounded-md md:inset-0  md:w-[40%] md:mt-28 md:mb-44 md:mx-auto">
      ...
      <input
        ...
        className="bg-[#333] px-6 py-4 mt-4 mb-2 rounded-md w-11/12 mx-4"
      ></input>
      <input
        type="password"
      ...
      <button className="w-11/12 bg-red-600 text-center text-white text-xl px-6 py-3 mx-4 mt-10 mb-2 rounded-md">
        Sign In
      </button>
